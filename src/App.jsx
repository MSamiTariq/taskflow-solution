 ...
 * Ensures only authenticated users (and optionally with a role) can access children.
 */
 ...
 * Shows children only when NOT authenticated; redirects authenticated users to their dashboard.
 */
        ...
        <Router>
          <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow">
              <Routes>
                {/* Public Routes (gated: show Login/Signup before Landing) */}
                <Route
                  path="/"
                  element={
                    <PublicRoute>
                ...
                {/* Optional: Make Landing accessible only after auth */}
                <Route
                  path="/landing"
                  element={
                    <ProtectedRoute>
